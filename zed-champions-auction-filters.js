// ==UserScript==
// @name         Zed Champions Auction Filters
// @namespace    http://tampermonkey.net/
// @version      1.8
// @description  Star + Bloodline + Win Rate + Color filtering on Zed Champions Auctions
...
let starFilters = [], bloodlineFilters = [], colorFilter = null, sortTimeAsc = false;
    let winrateFilter = null;
...
function filterAndSort() {
    ...
    cards.forEach(card => {
        ...
        card.classList.toggle('zed-card-hidden', !(starMatch && bloodMatch && colorMatch && winrateMatch));
    });
